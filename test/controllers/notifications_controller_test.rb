...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference('Notification.count') do
      post notifications_url, params: { notification: { message: @notification.message, rentalId: @notification.rentalId, userId: @notification.userId } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { message: @notification.message, rentalId: @notification.rentalId, userId: @notification.userId } }
